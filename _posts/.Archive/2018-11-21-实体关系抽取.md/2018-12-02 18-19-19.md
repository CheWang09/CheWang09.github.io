...
Figure 2
<br>
In addition, to evaluate the entites in relations. We calculated the coverage of entites in relations extracted compare with entities in entire entity base. And because of the different diversities of these three labels. Workplace is more easier has high converage than company
```table
