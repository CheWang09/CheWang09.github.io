...
The hld-out evaluation provides an approximate measure of precision without requiring costly human evaluation. 10% of the training data are used for testing. And Figure 2 shows the ROC Curve of our model which can represent the precision and recall. 
![](/img/Post_image/WechatIMG61.jpeg)
Figure 2
