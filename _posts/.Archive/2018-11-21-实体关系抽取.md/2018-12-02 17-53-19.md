...
Figure 2
To evaluate this PCNNs method, we select the following two methods for comparison. FP-Growth represents a traditional model that is a method of association rule learning. Another is CNN which is a deep learning method was proposed by LeCun, Yann
