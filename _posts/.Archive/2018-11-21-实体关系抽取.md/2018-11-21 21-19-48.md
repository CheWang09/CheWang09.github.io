...
At a high level, main purpose of our design is to improve the accuracy of recommendation. But in this report, we only discuss how to extract relations from three data sources and to establish a domain knowledge base.
Knowledge Base Construction S
