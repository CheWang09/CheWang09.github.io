...
### Design
First, we have to consider what kinds of relations we need. According to our name space, we would have relations like:
1. Relations between workpalce and company name
2. Relations b
3. 
###  Implementation
