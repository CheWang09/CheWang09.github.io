...
Figure 2
<br>
In addition, to evaluate the entites in relations. We calculated the coverage of entites in relations extracted compare with entities in entire entity base. And because of the d diversity of 
```table
 /                    |     entity base   |    entity extracted | Coverage
WordPlace       |    498    |    481 |  96.5%
